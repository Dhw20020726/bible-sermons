...
const SUCCESS_MESSAGE = 'Your message has been sent. Thank you very much.';

function ContactForm({open, onClose, onSuccess}) {
  ...
  return (
    <>
      <SlideDrawer open={open} onClose={onClose} title="Write message">
        <ContactForm open={open} onClose={onClose} onSuccess={handleSuccess} />
      </SlideDrawer>
      {toast ? (
